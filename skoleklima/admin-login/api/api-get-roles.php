...
$query = "SELECT RoleName, PermDescription FROM Role r JOIN RolePermission rp ON r.RoleID = rp.RoleID JOIN Permission p ON p.PermID = rp.PermID GROUP BY r.RoleName";
