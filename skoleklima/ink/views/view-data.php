...
<div class="single-view view-data">
    ...
    <div class="view-data-info-box">
        ...
        <h4>Information</h4>
        <p>On this page you have the opportunity to see detailed data from each location, as well as comparing data from
    ...
    <div class="graph-area-wrapper-1">
        <div class="canvas canvas1">
            <!-- canvas1 goes here -->
            <p class="canvasDataInfo" id="gettingDataWait"><i class="fa fa-spinner fa-spin fa-1x fa-fw"></i> Loading
                data...</p>
        ...
        <div class="canvas-1-settings">
            ...
            <div class="canvas-1-option-select-wrapper">
				<span class="canvas-settings-check inline-checkbox">
					<input id="check-chart-data-temperature" class="canvas-settings regular-checkbox" type="checkbox"
                           value="false">
					<label for="check-chart-data-temperature"></label>
					<p>Temperature</p>
				</span>
                <span class="canvas-settings-check inline-checkbox">
					<input id="check-chart-data-humidity" class="canvas-settings regular-checkbox" type="checkbox"
                           value="false">
					<label for="check-chart-data-humidity"></label>
					<p>Humidity</p>
				</span>
                <span class="canvas-settings-check inline-checkbox">
					<input id="check-chart-data-co2" class="canvas-settings regular-checkbox" type="checkbox"
                           value="false">
					<label for="check-chart-data-co2"></label>
					<p>CO2 level</p>
				</span>
                <span class="canvas-settings-check inline-checkbox">
					<input id="check-chart-data-noiseAvg" class="canvas-settings regular-checkbox" type="checkbox"
                           value="false">
					<label for="check-chart-data-noiseAvg"></label>
					<p>Sound average</p>
				</span>
                <span class="canvas-settings-check inline-checkbox">
					<input id="check-chart-data-noisePeak" class="canvas-settings regular-checkbox" type="checkbox"
                           value="false">
            ...
            <div class="canvas-settings-download">
                <div class="canvas-settings-download-head">
                    ...
                    <div class="download-info-box-wrapper">
                        <p>When the download button is hit, the data from the chosen location and timeperiod is
                            downloaded. </br>The data is downloaded in the xls-format that can be opened directly in
                            Microsoft Excel or the likes.</p>
                    </div>
                </div>
                <span>
    ...
    <div id="stat_single">
        <table id="stat_single_table" cellpadding="5" cellspacing="0" border="0"
               style="padding-left:50px; width: 100%;"></table>
    </div>
    <div id="stat_double">
        <table id="stat_double_table1" cellpadding="5" cellspacing="0" border="0"
               style="padding-left:50px; width: 50%; float: left"></table>
        <table id="stat_double_table2" cellpadding="5" cellspacing="0" border="0"
               style="padding-left:50px; width: 50%; float: right"></table>
    </div>
    ...
    <div class="graph-area-wrapper-2">
        <div class="canvas-wrapper canvas-wrapper-2">
            ...
            <p class="canvasDataInfo" id="gettingCompareDataWait"><i class="fa fa-spinner fa-spin fa-1x fa-fw"></i>
                Loading data...</p>
            <!-- canvas2 goes here -->
            <!-- canvas3 goes here -->
            <!-- canvas4 goes here -->
