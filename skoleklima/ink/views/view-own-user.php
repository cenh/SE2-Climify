...
<div class="single-view view-own-user">
    ...
    <div class="user-info-input">
		<span>
			...
			<input type="text" class="readonly" id="inp-onw-user-username" name=""
                   value="<?php echo $currentUserName; ?>" readonly="readonly">
		</span>
        <?php if ($currentUserRole == 2) { ?>
            <span>
			<label for="inp-onw-user-school">School</label>	
			<input type="text" class="readonly" id="inp-onw-user-school" name=""
                   value="<?php echo $currentUserSchoolAllowed; ?>" readonly="readonly">
		</span>
        <?php } ?>
        <span>
        ...
        <div class="change-own-pass">
			<span>
				...
				<i class="ico-hide-show-own-user-pass ico-hide-own-user-pass fa fa-eye-slash link"
                   aria-hidden="true"></i>
